...
if(document.addEventListener ){ 
   ...
   aLoader = [
    { load: "animate/demo/publish/web/edge_includes/jquery-1.7.1.min.js"},
    { load: "animate/demo/publish/web/edge_includes/edge.2.0.0.min.js"},
          { load: "animate/demo/publish/web/index_edge.js"},
          { load: "animate/demo/publish/web/index_edgeActions.js"}];
